...
namespace GameLauncher
{
    public partial class CSRWindow : Window
    {
        ...
        public CSRWindow()
        {
            ...
            rootPath = Path.Combine(AppSettings.InstallPath, "CSI Rogue");
        ...
        private void CheckForUpdates()
        {
            if (File.Exists(versionFile))
            {
                ...
                try
                {
                    VersionR onlineVersion = new VersionR(_http.GetStringAsync(
        ...
        private async void InstallGameFiles(bool isUpdate, VersionR onlineVersion)
        {
            try
            {
                if (isUpdate)
                ...
                else
                {
                    ...
                    onlineVersion = new VersionR(_http.GetStringAsync(
    ...
    struct VersionR
    {
        ...
        internal bool IsDifferentThan(VersionR other)
